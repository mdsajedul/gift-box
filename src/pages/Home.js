            ...
            <div >
                <div className="flex justify-center py-28">
                    <div className=''>
                        ...
                        <div className='py-3'>
                            <Link to="/boxes" type="button" className="text-white shadow-lg bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-0 font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
